...
*/
const CHUNK_BANK=[
  {id:"c_id_like",expression:"I'd like ...",type:"chunk",meaning:"〜をお願いします／〜したいです",band:"CORE",basis:"spoken-use core"},
  {id:"c_can_i",expression:"Can I ...?",type:"chunk",meaning:"〜してもいいですか？／〜できますか？",band:"CORE",basis:"spoken-use core"},
  {id:"c_could_you",expression:"Could you ...?",type:"chunk",meaning:"〜していただけますか？",band:"CORE",basis:"spoken-use core"},
  {id:"c_do_you_think",expression:"Do you think ...?",type:"chunk",meaning:"〜だと思いますか？",band:"CORE",basis:"COCA Spoken example"},
  {id:"c_i_guess",expression:"I guess ...",type:"chunk",meaning:"たぶん〜だと思います",band:"CORE",basis:"COCA Spoken example"},
  {id:"c_not_sure",expression:"I'm not sure ...",type:"chunk",meaning:"〜かよく分かりません／確信がありません",band:"CORE",basis:"spoken-use core"},
  {id:"c_depends",expression:"It depends on ...",type:"chunk",meaning:"〜によります",band:"CORE",basis:"spoken-use core"},
  {id:"c_looking_for",expression:"I'm looking for ...",type:"chunk",meaning:"〜を探しています",band:"CORE",basis:"spoken-use core"},
  {id:"c_need_to",expression:"I need to ...",type:"chunk",meaning:"〜する必要があります",band:"CORE",basis:"spoken-use core"},
  {id:"c_trying_to",expression:"I'm trying to ...",type:"chunk",meaning:"〜しようとしています",band:"CORE",basis:"spoken-use core"},
  {id:"c_how_about",expression:"How about ...?",type:"chunk",meaning:"〜はどうですか？",band:"CORE",basis:"spoken-use core"},
  {id:"c_what_do_you_mean",expression:"What do you mean?",type:"chunk",meaning:"どういう意味ですか？",band:"CORE",basis:"spoken-use core"},
  {id:"c_sounds",expression:"That sounds ...",type:"chunk",meaning:"それは〜そうですね",band:"HIGH",basis:"spoken-use core"},
  {id:"c_let_me",expression:"Let me ...",type:"chunk",meaning:"私に〜させてください／〜しますね",band:"HIGH",basis:"spoken-use core"},
  {id:"c_how_long",expression:"How long does it take?",type:"chunk",meaning:"どのくらい時間がかかりますか？",band:"HIGH",basis:"spoken-use core"},
  {id:"c_more_often",expression:"more often",type:"chunk",meaning:"もっと頻繁に",band:"HIGH",basis:"spoken-use core"},

  {id:"pv01",expression:"go on",type:"phrasal",meaning:"続く／続ける",band:"CORE",basis:"BNC",rank:1},
  {id:"pv02",expression:"carry out",type:"phrasal",meaning:"実行する",band:"CORE",basis:"BNC",rank:2},
  {id:"pv03",expression:"set up",type:"phrasal",meaning:"設置する／準備する",band:"CORE",basis:"BNC",rank:3},
  {id:"pv04",expression:"pick up",type:"phrasal",meaning:"受け取る／拾う／迎えに行く",band:"CORE",basis:"BNC",rank:4},
  {id:"pv05",expression:"go back",type:"phrasal",meaning:"戻る",band:"CORE",basis:"BNC",rank:5},
  {id:"pv06",expression:"come back",type:"phrasal",meaning:"戻ってくる",band:"CORE",basis:"BNC",rank:6},
  {id:"pv07",expression:"go out",type:"phrasal",meaning:"外出する",band:"CORE",basis:"BNC",rank:7},
  {id:"pv08",expression:"point out",type:"phrasal",meaning:"指摘する",band:"CORE",basis:"BNC",rank:8},
  {id:"pv09",expression:"find out",type:"phrasal",meaning:"調べて分かる／知る",band:"CORE",basis:"BNC",rank:9},
  {id:"pv10",expression:"come up",type:"phrasal",meaning:"話題・問題などが出てくる",band:"CORE",basis:"BNC",rank:10},
  {id:"pv11",expression:"make up",type:"phrasal",meaning:"作り上げる／構成する",band:"HIGH",basis:"BNC",rank:11},
  {id:"pv12",expression:"take over",type:"phrasal",meaning:"引き継ぐ",band:"HIGH",basis:"BNC",rank:12},
  {id:"pv13",expression:"come out",type:"phrasal",meaning:"出る／発売される",band:"HIGH",basis:"BNC",rank:13},
  {id:"pv14",expression:"come on",type:"phrasal",meaning:"さあ／始まる／進む",band:"HIGH",basis:"BNC",rank:14},
  {id:"pv15",expression:"come in",type:"phrasal",meaning:"入ってくる",band:"HIGH",basis:"BNC",rank:15},
  {id:"pv16",expression:"go down",type:"phrasal",meaning:"下がる",band:"HIGH",basis:"BNC",rank:16},
  {id:"pv17",expression:"work out",type:"phrasal",meaning:"うまくいく／解決する",band:"CORE",basis:"BNC",rank:17},
  {id:"pv18",expression:"set out",type:"phrasal",meaning:"出発する／着手する",band:"HIGH",basis:"BNC",rank:18},
  {id:"pv19",expression:"take up",type:"phrasal",meaning:"始める／占める",band:"HIGH",basis:"BNC",rank:19},
  {id:"pv20",expression:"get back",type:"phrasal",meaning:"戻る／取り戻す",band:"CORE",basis:"BNC",rank:20},
  {id:"pv21",expression:"sit down",type:"phrasal",meaning:"座る",band:"HIGH",basis:"BNC",rank:21},
  {id:"pv22",expression:"turn out",type:"phrasal",meaning:"結果的に〜となる／判明する",band:"CORE",basis:"BNC",rank:22},
  {id:"pv23",expression:"take on",type:"phrasal",meaning:"引き受ける",band:"HIGH",basis:"BNC",rank:23},
  {id:"pv24",expression:"give up",type:"phrasal",meaning:"諦める",band:"CORE",basis:"BNC",rank:24},
  {id:"pv25",expression:"get up",type:"phrasal",meaning:"起きる／立ち上がる",band:"HIGH",basis:"BNC",rank:25}
];
...
function chunkProg(id){return profile.chunkProgress[id]||{stage:0,seen:0,ok:0,miss:0,due:0,mastered:false}}
...
function renderChunks(){
  syncHighFrequencyCustom();
  if(state.chunks?.active)return renderChunkLesson();
  const learned=Object.values(profile.chunkProgress||{}).filter(p=>p.seen>0).length;
  const mastered=Object.values(profile.chunkProgress||{}).filter(p=>p.mastered).length;
  const due=allChunkItems().filter(isDue).length;
  view.innerHTML=`<section class="hero">
    <div class="kicker">APP 5 · CORPUS-PRIORITY</div>
    <h2>Chunks & Phrasal Verbs</h2>
    <p>単語を1個ずつではなく、よく使う「言葉の塊」のまま、例文・作文・発話・実戦まで。</p>
  </section>
  <section class="card">
    <div class="stats">
      <div class="stat"><b>${due}</b><span>今日の候補</span></div>
      <div class="stat"><b>${learned}</b><span>学習済み</span></div>
      <div class="stat"><b>${mastered}</b><span>定着</span></div>
    </div>
    <label>今日の例文テーマ</label>
    <input id="chunkTheme" value="旅行・日常・仕事" placeholder="例：海外旅行、仕事、不動産、友人との会話">
    ${chips(["海外旅行","仕事","日常会話","趣味・友人","レストラン・ホテル"],"#chunkTheme")}
    <button id="dailyChunks" class="primary wide">今日の5個を始める</button>
    <p class="note">句動詞はBNC高頻度を優先。一般チャンクは厳密な順位を表示せず、会話での再利用性を優先します。</p>
  </section>
  <section class="card">
    <h3>優先順位</h3>
    <div class="weakrow"><b>① あなた専用</b><div class="note">Realtime会話から保存したHIGH-FREQUENCY CHUNK</div></div>
    <div class="weakrow"><b>② CORE</b><div class="note">頻度と応用範囲が高く、先に覚える価値が高いもの</div></div>
    <div class="weakrow"><b>③ HIGH</b><div class="note">次に広げる表現</div></div>
  </section>
  <section class="card">
    <h3>句動詞のコーパス優先例</h3>
    ${CHUNK_BANK.filter(x=>x.type==="phrasal").slice(0,10).map(x=>`<div class="weakrow"><span class="levelBadge lv1">BNC #${x.rank}</span> <strong>${esc(x.expression)}</strong><div class="note">${esc(x.meaning)}</div></div>`).join("")}
  </section>`;
  bindCommon();
  $("#dailyChunks").onclick=startDailyChunks;
}
async function startDailyChunks(){
  const items=selectDailyChunks(),theme=$("#chunkTheme")?.value.trim()||"旅行・日常・仕事";
  loading("今日の5個を、あなたのテーマに合わせています…");
  try{
    ...
    state.chunks={active:true,theme,items:items.map(x=>({...x,lesson:byId[x.id]||{}})),index:0,step:1,writing:"",writingResult:null,results:[]};
    renderChunkLesson();
...
function renderChunkLesson(){
  ...
  else if(s.step===4)view.innerHTML=head+`<div class="card center"><h3>3秒で口から出す</h3><div class="big">${esc(l.speakingPromptJa||item.meaning)}</div><button id="chunkCount" class="primary wide">3秒スタート</button><div id="chunkCD" class="countdown"></div><div id="chunkModel" class="hidden"><div class="en big">${esc(l.example||item.expression)}</div><button id="chunkModelHear" class="audioBtn">🔊 聞く</button><div class="row" style="margin-top:12px"><button id="chunkOK" class="primary">言えた</button><button id="chunkMiss" class="secondary">まだ</button></div></div></div>`;
  ...
  if(s.step===4){
    $("#chunkCount").onclick=()=>{let n=3;$("#chunkCD").textContent=n;const t=setInterval(()=>{n--;$("#chunkCD").textContent=n>0?n:"GO!";if(n<=0){clearInterval(t);setTimeout(()=>$("#chunkModel").classList.remove("hidden"),1200)}},1000)};
    $("#chunkModelHear").onclick=()=>playTTS(l.example||item.expression);
    $("#chunkOK").onclick=()=>finishChunkItem(true);
    $("#chunkMiss").onclick=()=>finishChunkItem(false);
  }
}
function finishChunkItem(ok){
  const s=state.chunks,item=s.items[s.index];
  updateChunkResult(item,ok);
  if(ok)markWeakSuccess(item.expression);
