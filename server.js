...
app.post("/api/mission-review", safe(async b => askJSON({
  instructions: `You are a concise English coach for Japanese beginners. During role-play there was no correction. Now, and only now, review accuracy. NEXT maximum 2. Detect recurring-looking issues conservatively. Return JSON only.`,
  input: `場面:${b.scene}\nミッション:${JSON.stringify(b.missions)}\n会話:${JSON.stringify(b.transcript)}\n既存苦手:${JSON.stringify(b.weaknesses||[])}\nGOODは1〜2文。NEXT最大2。BETTER ENGLISH最大2。weaknesses最大3。typeはexpression/grammar/vocabulary/listening/fluency。severityHintは1〜3。\nJSON:{"good":"...","next":["..."],"betterEnglish":[{"original":"...","better":"...","ja":"..."}],"weaknesses":[{"type":"expression","label":"...","original":"...","better":"...","ja":"...","severityHint":1}]}`
})));
