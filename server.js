...
app.post("/api/chunk-transcribe", async (req,res) => {
  try{
    ...
    const bytes=Buffer.from(audio,"base64"),fd=new FormData();fd.set("file",new Blob([bytes],{type:mime}),"speech.webm");fd.set("model","gpt-4o-mini-transcribe");fd.set("language","en");
